function IconWithName({ icon: IconComponent, name }) {
    ...
    return (
        ...
        <div className="flex flex-col relative cursor-pointer group hover:scale-105 rotate-5">
            ...
            <div
                className={`font-rodin border-3 border-menu-blue p-1 ${isLinkedin} absolute -right-25 -bottom-7 -rotate-20 bg-menu-blue-icons text-white group-hover:text-menu-cyan-main`}
            >
